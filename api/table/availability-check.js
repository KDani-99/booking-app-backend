                    ...
                    for(var cTime2=latestDate;cTime2<60;cTime2+=interval)
                    {
                        ...
                        for(let j=breakPoint === null ? 0 : breakPoint;j<breaks.length;j++)
                        {
                            ...
                            for(let k=j;k<breaks.length;k++)
                            {
                                ...
                                {
                                    console.log(breaks[k])
                                    skipBreak = k;
                                    break;
                                }*/
                                if(break_end_splitted[0] === break_start_splitted1[0] && break_end_splitted[1] === break_start_splitted1[1])
                                {
                                    console.log('happens')
                                    canAddBreakEnd = false
                                }
                            }
                            /*if(skipBreak !== null)
                            {
                            ...
                            if(canAddBreakEnd)
                            {
                                result.push(`${break_end_splitted[0]}:${break_end_splitted[1]}`);
                                i = break_end_splitted[0]-1;
                                cTime2 = break_end_splitted[0]-interval;
                                fastForward = true;
                                break;
                            }
                            // ! <-- EXPERIMENT -->
                            ...
                            if(break_end_splitted[0] === i && break_end_splitted[1] == cTime2) console.log('same')
                            if(break_start_splitted[0] < i && break_end_splitted[0] > i ||
                               (break_start_splitted[0] === i && break_start_splitted[1] <= cTime2 && break_end_splitted[0] === i && break_end_splitted[1] >= cTime2) ||
                               (break_end_splitted[0] === i && break_end_splitted[1] >= cTime2)
                            )
                            {
                                console.log('MACHINE GUN',i,cTime2)
                                breakPoint = j;
                                breakCollision = true;
                                break;
                            }
